...
// from the service definitions in pilot.yaml.
// It is invoked by pilot up when the required files are absent.
package composer
...
var composeTmpl = template.Must(template.New("compose").Funcs(composeFuncMap).Parse(`# Generated by pilot up — edit if needed, or delete to regenerate.
# Source of truth: pilot.yaml
