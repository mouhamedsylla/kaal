...
//
//	go build -ldflags "-X github.com/mouhamedsylla/kaal/internal/version.Version=v0.1.0"
//
...
// String returns the full version string shown by kaal version / kaal update.
func String() string {
	if Version == "dev" {
